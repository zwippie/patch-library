...
const CANVAS_HEIGHT = 776;
const CABLE_WIDTH = 6;
const CELL_RADIUS = 12;
const CONNECTORS = [
  //inputs
  //row 1
  {idx: 0, col: 0, row: 0, x: 325, y: 110, name: "OSC CV", input: true},
  ...
  {idx: 8, col: 8, row: 0, x: 850, y: 110, name: "MULTIPLE", input: true},
  //row 2
  ...
  {idx: 12, col: 3, row: 1, x: 525, y: 175, name: "PLAY/STOP", input: true},
  {idx: 13, col: 4, row: 1, x: 590, y: 175, name: "RESET", input: true},
  {idx: 14, col: 5, row: 1, x: 655, y: 175, name: "HOLD", input: true},
  {idx: 15, col: 6, row: 1, x: 720, y: 175, name: "ENV GATE", input: true},
  {idx: 16, col: 7, row: 1, x: 785, y: 175, name: "VCA CV", input: true},
  {idx: 17, col: 8, row: 1, x: 850, y: 175, name: "LFO RATE", input: true},

  //outputs
  //row 1
  {idx: 18, col: 9, row: 0, x: 915, y: 110, name: "MULTIPLE 1", input: false},
  {idx: 19, col: 10, row: 0, x: 980, y: 110, name: "MULTIPLE 2", input: false},
  {idx: 20, col: 11, row: 0, x: 1045, y: 110, name: "OSC PULSE", input: false},
  {idx: 21, col: 12, row: 0, x: 1110, y: 110, name: "OSC SAW", input: false},
  {idx: 22, col: 13, row: 0, x: 1177, y: 110, name: "ENV", input: false},
  {idx: 23, col: 14, row: 0, x: 1245, y: 110, name: "NOISE", input: false},
  {idx: 24, col: 15, row: 0, x: 1310, y: 110, name: "VCA/LINE", input: false},

  //outputs
  //row 2
  {idx: 25, col: 9, row: 1, x: 915, y: 175, name: "LFO TRI", input: false},
  {idx: 26, col: 10, row: 1, x: 980, y: 175, name: "LFO SQU", input: false},
  {idx: 27, col: 11, row: 1, x: 1045, y: 175, name: "VC MIX", input: false},
  {idx: 28, col: 12, row: 1, x: 1110, y: 175, name: "ASSIGN", input: false},
  {idx: 29, col: 13, row: 1, x: 1177, y: 175, name: "KB CV", input: false},
...
const KNOBS = [
  ...
  {idx: 2, x: 486, y: 293, type: "large", name: "OSC MOD"},
  ...
  {idx: 6, x: 1185, y: 293, type: "large", name: "VCF MOD"},
