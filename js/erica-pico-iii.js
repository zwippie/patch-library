...
const CONNECTORS = [
  ...
  {idx: 10, x: 635, y: 260, name: "VCO2 1V/OCT", input: true},
  {idx: 11, x: 635, y: 325, name: "SHAPE CV", input: true},
  {idx: 12, x: 635, y: 390, name: "VCO2 SHAPE", input: false},
  {idx: 13, x: 635, y: 455, name: "VCO2 TRI", input: false},
...
const KNOBS = [
  {idx: 0, x: 438, y: 68, type: "small", name: "SEQ 1"},
